    ...
    <div class="footer-content">
      <div class="footer-columns">
        <div class="footer-col anim-col-1">
          ...
          <p class="footer-text">Soluciones logísticas inteligentes para tus envíos internacionales.</p>
        ...
        <div class="footer-col anim-col-3">
          ...
          <ul class="footer-contact">
            <li>
              ...
              <span>contacto@tucajaexpress.com</span>
            </li>
            <li>
              ...
              <span>+1 704-820-6911</span>
            </li>
            <li>
              <svg viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
              <span>Encomiendas y Paquetería a México y Centro América</span>
            </li>
          </ul>
        </div>
